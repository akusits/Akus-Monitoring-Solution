"""
Django settings for monitoring_solution project.
...
SECRET_KEY = 'a1gki@(6wm5a$)%=xsm)t_@a!v))eu1lwqkgzk0th$b22ft_u@'
...
ROOT_URLCONF = 'monitoring_solution.urls'
...
WSGI_APPLICATION = 'monitoring_solution.wsgi.application'
